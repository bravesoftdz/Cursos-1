...
//  sMensagem   : String;
//  iOperacao   : Integer;
//  function TratarValor(AConteudo: String): String;
//  begin
//    Result := StringReplace(ANotification.Json.GetValue(AConteudo).ToString, '"', EmptyStr, [rfReplaceAll]);
//  end;
//
//begin
//  sMensagem := StringReplace(ANotification.Json.GetValue('mensagem').ToString          , '"', EmptyStr, [rfReplaceAll]);
//  iOperacao := StrToInt(StringReplace(ANotification.Json.GetValue('operacao').ToString , '"', EmptyStr, [rfReplaceAll]));
//end;
