...
type
  TWM = class(TWebModule)
   ...
   DSAuthenticationManager1: TDSAuthenticationManager;
    ...
    DSServerClassEstabelecimentos: TDSServerClass;
    ...
    procedure DSServerClassEstabelecimentosGetClass(
      DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
    procedure DSAuthenticationManager2UserAuthenticate(Sender: TObject;
      const Protocol, Context, User, Password: string; var valid: Boolean;
      UserRoles: TStrings);
  private
...
procedure TWM.DSServerClass1GetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := UntSrvMetodosGerais.TSrvMetodosGerais;
end;

procedure TWM.DSServerClassEstabelecimentosGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := UntSmServicos.TSmServicos;
end;
...
procedure TWM.DSAuthenticationManager1UserAuthorize(
...
procedure TWM.DSAuthenticationManager2UserAuthenticate(Sender: TObject;
  const Protocol, Context, User, Password: string; var valid: Boolean;
  UserRoles: TStrings);
begin
  //
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := UntSrvMetodosGerais.TSrvMetodosGerais.ClassName
